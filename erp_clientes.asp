...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  if request.QueryString("idclien")<>0 then
  		if request.QueryString("accion")="x" then
				sql=" delete from erp_clien where idclien=" &request.QueryString("idclien")
  ...
  %>
	...
	%>
      ...
      <div class="row">
        <div class="col-md-12">
		        		<form class="form-signin" action="erp_clientes.asp" method="post">
				...
				<button class="btn btn-lg btn-primary btn-block" type="submit">Buscar</button>
			      ...
			      <p>
					<span class="label label-success">F) Facturar</span>
            ...
            <tbody>
			  <%
				...
				do while not rs.eof 
    	            ...
    	            <td>
				      <p>
				        <a href="erp_abcfac.asp?accion=g&idclien=<%=rs("idclien")%>"><span class="label label-success">F</span></a>
				        <a href="erp_historia.asp?idclien=<%=rs("idclien")%>"><span class="label label-info">H</span></a>
					    <a href="erp_abccli.asp?accion=e&idclien=<%=rs("idclien")%>"><span class="label label-warning">E</span></a>
				        <a href="erp_clientes.asp?accion=x&idclien=<%=rs("idclien")%>"><span class="label label-danger">X</span></a>
				      </p>					
					</td>
    	            <td><%=rs("idclien")%></td>
        	        <td><%=rs("razon")%></td>
